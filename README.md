...
[![GitHub Tests Action Status](https://img.shields.io/github/actions/workflow/status/marvinrabe/laravel-graphql-test/run-tests.yml?branch=master)](https://github.com/marvinrabe/laravel-graphql-test/actions?query=workflow%3ATests+branch%3Amaster)
